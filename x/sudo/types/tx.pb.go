...
func init() {
	proto.RegisterType((*MsgUpdateAdmin)(nil), "sojahub.sojahub.sudo.MsgUpdateAdmin")
	proto.RegisterType((*MsgUpdateAdminResponse)(nil), "sojahub.sojahub.sudo.MsgUpdateAdminResponse")
}
...
func (c *msgClient) UpdateAdmin(ctx context.Context, in *MsgUpdateAdmin, opts ...grpc.CallOption) (*MsgUpdateAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sojahub.sojahub.sudo.Msg/UpdateAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sojahub.sojahub.sudo.Msg/UpdateAdmin",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sojahub.sojahub.sudo.Msg",
